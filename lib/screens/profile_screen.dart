...
//             physics: const BouncingScrollPhysics(),
//             slivers: [
//               // 🔹 Pass Phone here to display it
//               _buildSliverAppBar(userName, userEmail, photoUrl, base64Photo, phone),
...
//                       _buildEditProfileButton(context, userName, base64Photo, phone, bio),
...
//   // 🔹 Updated to accept phone for visibility
//   Widget _buildSliverAppBar(String userName, String userEmail, String? photoUrl, String? base64Photo, String? phone) {
...
//                             // 🔹 VISIBILITY: Show Phone Number if exists
...
//   // 🔹 Updated to pass all fields to Edit Screen
...
//     return Container(
//       padding: const EdgeInsets.symmetric(vertical: 16, horizontal: 12),
//       decoration: BoxDecoration(color: bgColor, borderRadius: BorderRadius.circular(16), boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.03), blurRadius: 10, offset: const Offset(0, 4))]),
